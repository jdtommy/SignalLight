...
func (d Device) Disconnect() error {
	if d.disconnected != nil && !atomic.CompareAndSwapUint32(d.disconnected, 0, 1) {
		return nil
	}
	...
	if d.connectionStatusListener != nil {
		...
		_ = d.connectionStatusListener.Release()
	}
...
func (d Device) Connected() (bool, error) {
	if d.disconnected != nil && atomic.LoadUint32(d.disconnected) != 0 {
		return false, nil
	}
	if d.device == nil {
		return false, nil
